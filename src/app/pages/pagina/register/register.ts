  ...
  template: `
    <div class="min-h-screen flex items-center justify-center relative overflow-hidden p-4 py-8">
      ...
      <div class="absolute inset-0 pointer-events-none">
        <div class="absolute w-[600px] h-[600px] bg-emerald-500/10 rounded-full blur-3xl -top-48 -right-32"></div>
        <div class="absolute w-[500px] h-[500px] bg-teal-500/10 rounded-full blur-3xl -bottom-48 -left-32"></div>
      </div>
