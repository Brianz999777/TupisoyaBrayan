            ...
            <div class="flex-1">
                <section class="relative pt-32 pb-28 overflow-hidden">
                    ...
                    <div class="relative z-10 max-w-[90rem] mx-auto px-8 lg:px-24 text-center">
                        <h1 class="text-4xl md:text-5xl font-black text-gray-900 dark:text-white mb-4">Filtros <span class="text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 to-teal-500">avanzados</span></h1>
                        <p class="text-lg text-gray-500 dark:text-gray-400 max-w-2xl mx-auto">Refina tu búsqueda con filtros personalizados.</p>
                    </div>
                </section>
                <section class="py-12 bg-gray-50 dark:bg-gray-900/50">
                    <div class="max-w-4xl mx-auto px-6">
                        <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 md:p-10 shadow-xl shadow-emerald-500/5 border border-gray-100 dark:border-gray-700 text-center">
                            <div class="w-24 h-24 rounded-2xl bg-gradient-to-br from-amber-400 to-orange-500 flex items-center justify-center mx-auto mb-6">
                                <i class="pi pi-sliders-h text-4xl text-white"></i>
                            </div>
                            <h2 class="text-2xl font-black text-gray-900 dark:text-white mb-3">Filtros en desarrollo</h2>
                            <p class="text-gray-500 dark:text-gray-400 max-w-md mx-auto mb-8">Estamos afinando nuestros filtros para que encuentres exactamente lo que buscas. Vuelve pronto.</p>
